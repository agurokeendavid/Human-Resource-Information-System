...
namespace HRISCapsu
{
    public partial class frmEmployeesRecord : Form
    {
        ...
        {
            if (txtEmployeeNo.Text != "" && txtFirstName.Text != "" && txtMiddleName.Text != "" && txtLastName.Text != "" && txtAddress.Text != "" && cmbGender.Text != "" && dtpDateofBirth.Text != "" && txtPlaceofBirth.Text != "" && txtContactNo.Text != "" && cmbCivilStatus.Text != "" && cmbPosition.Text != "" && cmbDepartment.Text != "" && cmbWorkStatus.Text != "" && dtpHiredDate.Text != "" && dtpEndofContract.Text != "")
            {
                if (btnSave.Text == "&Save")
                {
                    try
                    {
                        ...
                        {
                            conn.Open();
                            string query = "INSERT INTO employees (employee_no, first_name, middle_name, last_name, address, gender, date_of_birth, place_of_birth, contact_no, civil_status, position_id, department_id, work_status, hired_date, end_of_contract) VALUES (@employee_no, @first_name, @middle_name, @last_name, @address, @gender, @date_of_birth, @place_of_birth, @contact_no, @civil_status, @position_id, @department_id, @work_status, @hired_date, @end_of_contract)";
                            var cmd = new MySqlCommand(query, conn);
        ...
        {
            var frm = new frmViewEmployee(dtgRecords.CurrentRow.Cells[0].Value.ToString(), dtgRecords.CurrentRow.Cells[1].Value.ToString(), dtgRecords.CurrentRow.Cells[2].Value.ToString(), dtgRecords.CurrentRow.Cells[3].Value.ToString(), dtgRecords.CurrentRow.Cells[4].Value.ToString(), dtgRecords.CurrentRow.Cells[5].Value.ToString(), dtgRecords.CurrentRow.Cells[6].Value.ToString(), dtgRecords.CurrentRow.Cells[7].Value.ToString(), dtgRecords.CurrentRow.Cells[8].Value.ToString(), dtgRecords.CurrentRow.Cells[9].Value.ToString(), dtgRecords.CurrentRow.Cells[10].Value.ToString(), dtgRecords.CurrentRow.Cells[11].Value.ToString(), dtgRecords.CurrentRow.Cells[12].Value.ToString(), dtgRecords.CurrentRow.Cells[13].Value.ToString(), dtgRecords.CurrentRow.Cells[14].Value.ToString());
            frm.ShowDialog();
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmbGender.SelectedItem = dtgRecords.CurrentRow.Cells[5].Value.ToString();
            ...
            cmbCivilStatus.SelectedItem = dtgRecords.CurrentRow.Cells[9].Value.ToString();
            cmbPosition.SelectedItem = dtgRecords.CurrentRow.Cells[10].Value.ToString();
            cmbDepartment.SelectedItem = dtgRecords.CurrentRow.Cells[11].Value.ToString();
            cmbWorkStatus.SelectedItem = dtgRecords.CurrentRow.Cells[12].Value.ToString();
            dtpHiredDate.Text = dtgRecords.CurrentRow.Cells[13].Value.ToString();
            if (cmbWorkStatus.SelectedItem == "Regular")
            {
                label14.Visible = false;
                dtpEndofContract.Visible = false;
            }
